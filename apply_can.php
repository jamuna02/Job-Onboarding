...
$sq = "SELECT * FROM `j_applied` WHERE pj_uname='$u' AND status='' ";
// Execute query
...
if($records==0){
  ...
  <br>
  <tr>
  <h3> NO CANDIDATE HAS BEEN APPLIED FOR THE JOB </h3>
  </tr>
  <?php
}
...
<tr>
  ...
  <td class="b"><a class="del" href="j_sel.php?id=<?php echo $i;?>">Select  </a>  / <br><a  class="del" href="j_can.php?id=<?php echo $i;?>">Reject</a></td>
</tr>
