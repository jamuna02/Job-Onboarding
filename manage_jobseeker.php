...
$sq = "SELECT * FROM `signin` WHERE susertype='j' ";
// Execute query
...
<tr>
  ...
  <td class="b"><a class="del" href="juser_dt.php?n=<?php echo $u;?>">View</a></td>
  <td class="b"><a class="del" href="juser_jdt.php?n=<?php echo $u;?>">View</a></td>
  <td class="b"><a class="del" href="juser_sjdt.php?n=<?php echo $u;?>">View</a></td>
