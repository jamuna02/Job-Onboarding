...
<body class="box">
	...
	<div class="box1">
      ...
      <li ><a href="jmainpg.html"> Home </a> </li>			
            ...
            <li><a class="h" href="rej_job.php" target="blank"> Rejected Job</a> </li>	
...
$sq = "SELECT * FROM `j_applied` WHERE ap_name='$u' AND status='Rejected' ";
// Execute query
...
if($records==0){
  ...
  <br>
  <tr>
  <h3> NOT REJECTED FOR ANY JOB </h3>
  </tr>
  <?php
}
