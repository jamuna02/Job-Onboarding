...
<body class="box">
	...
	<div class="box1">
      ...
      <li ><a href="cmainpg.html"> Home </a> </li>			
				...
				<li><a class="h" href="selected.php" target="blank"> Selected candidate </a> </li>
...
$sq = "SELECT * FROM `j_applied` WHERE pj_uname='$u' AND status='Selected' ";
// Execute query
...
if($records==0){
  ...
  <br>
  <tr>
  <h3> NO CANDIDATE HAS BEEN SELECTED FOR THE JOB </h3>
  </tr>
  <?php
}
...
<tr>
  ...
  <td class="b"><a class="del" href="j_can.php?id=<?php echo $i;?>">Reject</a></td>
</tr>
